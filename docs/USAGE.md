...
适用版本：suite10，Minecraft 1.12.2。快捷键可以在游戏设置中调整，下表是默认值。所有步骤都以已适配的界面为前提，见[兼容表](COMPATIBILITY.md)。

## 安装与第一条配方链

1. 从 [Release](https://github.com/lingning0806/HEI-Recipe-Chain/releases/tag/v4.29.13-nova.10-suite10) 下载 `HadEnoughItems_1.12.2-4.29.13-nova.10-suite10.jar`。
