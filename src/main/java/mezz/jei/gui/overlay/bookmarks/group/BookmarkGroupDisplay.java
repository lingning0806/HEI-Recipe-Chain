...
public class BookmarkGroupDisplay implements IGhostIngredientHandler.Target {
    ...
    public void accept(Object ingredient) {
        if (ingredient instanceof mezz.jei.autocrafting.RecipeBookmarkItem) {
            // Recipe rows belong to a chain. Never move a shared node in place.
            // Use the bracket operation, whose transaction rebuilds both groups.
            return;
        }
