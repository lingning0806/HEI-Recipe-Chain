...
public class RecipeTransferErrorTooltip implements IRecipeTransferError {
    ...
    /** Player-facing explanation, without the generic transfer heading. */
    public String getReason() {
        return TextFormatting.getTextWithoutFormattingCodes(String.join(" ", message.subList(1, message.size())));
    }
