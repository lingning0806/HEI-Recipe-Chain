...
public class PacketHandler {
	...
	public PacketHandler() {
        serverHandlers.put(PacketIdServer.PROJECTION_FILL, mezz.jei.network.packets.PacketProjectionFill::readPacketData);
        serverHandlers.put(PacketIdServer.AE2_PULL, mezz.jei.network.packets.PacketAePull::readPacketData);
        serverHandlers.put(PacketIdServer.AE2_PATTERN_BATCH, mezz.jei.network.packets.PacketPatternBatch::readPacketData);
		serverHandlers.put(PacketIdServer.AE2_CRAFT, mezz.jei.network.packets.PacketAe2Craft::readPacketData);
